...
export function BookingStrip() {
  const handleCheck = () => {
    const msg = encodeURIComponent(
      `Hello! I'd like to inquire about booking a room. Please let me know your availability. Thank you!`
    );
    ...
    <section className="py-24 px-4 md:px-8 bg-cream-light text-forest-black">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
        ...
        >
          ...
          <p className="text-charcoal/70 text-[16px] leading-relaxed mb-8 max-w-md">
          ...
          <Button variant="primary" size="lg" onClick={handleCheck} className="w-fit text-sm tracking-wider uppercase font-cinzel rounded-sm bg-forest-black hover:bg-forest text-gold-primary border-none px-8 py-4">
            Reserve Now →
          </Button>
        </motion.div>
