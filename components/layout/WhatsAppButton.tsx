...
export function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-[max(1.5rem,env(safe-area-inset-bottom,1.5rem))] right-5 sm:bottom-8 sm:right-8 z-40 flex items-center gap-3">
      {/* Tooltip */}
      <div
      ...
      >
        <div className="bg-forest border border-gold-primary/20 text-cream text-[11px] px-3 py-1.5 rounded-lg whitespace-nowrap shadow-lg">
          Chat on WhatsApp
        </div>
      </div>
